...
extern int __bam_cdel_redo(DB *, PAGE *, __bam_cdel_args *, DB_LSN *);
extern int __bam_cdel_undo(DB *, PAGE *, __bam_cdel_args *, int);
	...
	PAGE *pagep;
{
	...
	ret = __bam_cdel_undo(file_dbp, pagep, argp, 0 /* Snapshot rollback should not affect other cursors */);
