...
ifneq ($(QUATERNARY_DB_PREFIX),)
export QUATERNARY_DBNAME=$(QUATERNARY_DB_PREFIX)$(DBNAME)
export QUATERNARY_DBDIR=$(TESTDIR)/$(QUATERNARY_DBNAME)
export QUATERNARY_CDB2_CONFIG=$(abspath $(QUATERNARY_DBDIR)/comdb2db.cfg)
export QUATERNARY_CDB2_OPTIONS=--cdb2cfg $(QUATERNARY_CDB2_CONFIG)
endif

ifneq ($(QUINARY_DB_PREFIX),)
export QUINARY_DBNAME=$(QUINARY_DB_PREFIX)$(DBNAME)
export QUINARY_DBDIR=$(TESTDIR)/$(QUINARY_DBNAME)
export QUINARY_CDB2_CONFIG=$(abspath $(QUINARY_DBDIR)/comdb2db.cfg)
export QUINARY_CDB2_OPTIONS=--cdb2cfg $(QUINARY_CDB2_CONFIG)
endif

ifneq ($(SENARY_DB_PREFIX),)
export SENARY_DBNAME=$(SENARY_DB_PREFIX)$(DBNAME)
export SENARY_DBDIR=$(TESTDIR)/$(SENARY_DBNAME)
export SENARY_CDB2_CONFIG=$(abspath $(SENARY_DBDIR)/comdb2db.cfg)
export SENARY_CDB2_OPTIONS=--cdb2cfg $(SENARY_CDB2_CONFIG)
endif
