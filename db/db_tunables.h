...
REGISTER_TUNABLE("physrep_hung_replicant_threshold",
                 ...
                 NULL, NULL, NULL);
REGISTER_TUNABLE("physrep_update_registry_interval",
                 "Physrep update-registry interval. (Default: 60)",
                 TUNABLE_INTEGER, &gbl_physrep_update_registry_interval, 0, NULL,
                 NULL, NULL, NULL);
REGISTER_TUNABLE("physrep_revconn_check_interval",
                 "Physrep recheck revconn interval.  (Default: 60)",
                 TUNABLE_INTEGER, &gbl_physrep_revconn_check_interval, 0, NULL,
                 NULL, NULL, NULL);
